export default async function handler(req, res) {
    ...
    const prompt = `Generate ${numQuestions} objective questions about "${topic}" tailored exactly to a **${difficulty}** level of difficulty. Each question should have exactly 4 options (A, B, C, D), one correct answer, and a short, concise explanation. Provide the output as a JSON array of objects. Each object should have 'questionText', 'options' (an array of strings), 'correctAnswer' (the exact text matches one of your options array strings), and 'explanation'.`;
